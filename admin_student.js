...
module.exports = {
      ...
      async function connectAndDelete() {  
                        ...
                        try {
                          ...
                          var deletestmt  = "DELETE FROM reservation WHERE STUDENTID = " + studentID + ";";
                              ...
                              deletestmt += "DELETE FROM account_student WHERE STUDENTID = " + studentID + ";";
  ...
  studenttableinsertfunc: function(req, res)  {
      ...
      async function connectAndMaybeInsert() {    
                        ...
                        //insert student
                        const client2 = new Client(connectobj);
                        try {
                            ...
                            const insertRes = await client2.query(insertstmt);
                        ...
                        //query student
                        const client3 = new Client(connectobj);
                        var queryres;
                        try {
                            await client3.connect();
                            var query = "SELECT * FROM student WHERE EMAIL='" + email + "';";
                            queryres = await client3.query(query);
                        } catch (err) {
                            await client3.end();
                        ...
                        try {
                            ...
                            stmtres = await client4.query(stmt);
                        } catch (err) {
                            await client4.end();
